    ...
    win.document.write(`
      ...
      <body>
        ...
        <div style="display:flex;align-items:center;gap:14px;margin-bottom:8px;">
          <img src="/logo.jpg" style="width:52px;height:52px;border-radius:12px;object-fit:cover;" alt="logo"/>
          <div>
            <h1 style="margin:0;">AI Health Intelligence Report</h1>
            <p style="color:#6b7280;font-size:13px;margin:2px 0 0;">Generated by Multi-Agent Symptom Journal System</p>
          </div>
        </div>
